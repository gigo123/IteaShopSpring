...
<div class="col-6">
	...
	<form action="./register" method="post" class="form form--account">
		<div class="row mb--20">
			<div class="col-12">
				<div class="form__group">
					<label class="form__label" for="login">Login (email
						address) <span class="required">*</span>
					</label> <input type="email" name="login" id="login" class="form__input"
			...
			<div class="col-12">
				<div class="form__group">
					<label class="form__label" for="name">Display name <span
						class="required">*</span></label> <input type="text" name="name" id="name"
						value="${user.name}" class="form__input" required> <span
						class="form__notes"><em>This will be how your name
							will be displayed in the account section and in reviews</em></span>
				</div>
			</div>
		</div>
		<div class="form__group">
			<div class="row">
				<div class="col-3">
					<label class="form__label">Select region </label>
				</div>
				<div class="col-3">
					<select name="region">
						<option value="DNR"
				...
				<div class="col-3">
					<div class="radioDiv">
						<input type="radio" class="radio" name="gender" value="Male"
							id="radio-1"required ${user.gender?"checked":""}> <label
							for="radio-1"> Male</label>
					</div>
				</div>
				<div class="col-3">
					<div class="radioDiv">
		...
		<div class="row">
			<div class="col-12">
				<div class="form__group">
					<label class="form__label checkbox-label" for="acceptOffer">
						<input type="checkbox" name="acceptOffer" id="store_session">
